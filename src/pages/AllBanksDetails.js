...
const TABLE_HEAD = [
  ...
  { id: 'bankaccount', label: 'Bank Account No', alignRight: false },
  { id: 'bankname', label: 'Bank Name', alignRight: false },
  { id: 'ifsc', label: 'IFSC Code', alignRight: false },
...
export default function AllBanksDetails() {
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, bankName, ifsc, accountNo, branch, userid } = row;
                    const selectedUser = selected.indexOf(userid) !== -1;

                    return (
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={_id}>
