...
const TABLE_HEAD = [
    { id: 'productbookingid', label: 'Product Booking ID', alignRight: false },
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        const { _id, user, DeliveryFee, TotalAmount, TotalQuantity, addressLine1, addressLine2, city, deliveryNote, order, paymentId, deliveryStatus, phone, promocodeApplied, state, serviceProviderId, createdAt } = row;
                                        ...
                                        return (
                                            <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                                                ...
                                                <TableCell align="left">
                                                    <MenuItem onClick={() => navigate('/dashboard/productorderdetails', { state: row })}>
