...
const TABLE_HEAD = [
  ...
  { id: 'mailid', label: 'Mail Id', alignRight: false },
  { id: 'query/feedback', label: 'Query/Feedback', alignRight: false },
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, name, email, query } = row;
                    const selectedUser = selected.indexOf(name) !== -1;

                    return (
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={name}>
