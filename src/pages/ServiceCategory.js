...
export default function ServiceCategory() {
    ...
    useEffect(() => {
        fetchUser(); _getasync(); fetchUser2();
    }, []);
                    ...
                    <Scrollbar>
                        ...
                        <Modal open={open2} onClose={onCloseModal} center>
                            <Stack spacing={3}>
                                ...
                                <TextField name="Service" label="Category Name" onChange={(event) => setServiceCategory(event.target.value)} />
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        const { _id, categoryName, serviceId, createdAt, serviceData } = row;
